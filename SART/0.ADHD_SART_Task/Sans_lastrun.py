...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Wed Nov 18 12:17:12 2015
...
expInfo = {u'participant': u'', u'schedule': u'1'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/amanda_renfro3/Google Drive/FIU - PhD/ADHD_RTV/ADHD_SART_Task/Sans.psyexp',
...
text = visual.TextStim(win=win, ori=0, name='text',
    text='Welcome to the task.\n\nYour job in this experiment is to hit the "1" button for every number that appears other than a "3". \nWhen a "3" appears, you will refrain from hitting the "1" button.\n\nEvery so often, you will be presented with two words. Please select the word from the pair that you prefer by hitting the "1" button for the word on the left, and "2" for the word on the right.',    font='Arial',
...
while continueRoutine:
    ...
    if text.status == STARTED and t >= (20-win.monitorFramePeriod*0.75): #most of one frame period left
