...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.83.01), Wed Feb 10 19:44:21 2016
...
expName = 'SART_RTV'  # from the Builder filename that created this script
expInfo = {u'version': u'0', u'participant': u'', u'schedule': u'1'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/amandarenfro/Google Drive/FIU - PhD/MaD Lab/ADHD_RTV/ADHD_SART_Task/WingDing.psyexp',
...
for thisCondition_loop in condition_loop:
    ...
    for thisTrial in trials:
        ...
        if stim==target:
            ...
            if type(trial_resp.rt) is not float and version == 0:
                trial_resp.rt = 0
        ...
        if type(trial_resp.rt) is float and not (version == 1 and stim==target):
        ...
        for thisConditional_run in conditional_run:
            ...
            while continueRoutine and routineTimer.getTime() > 0:
                ...
                if probe_stim1.status == STARTED and t >= (0.0 + (2-win.monitorFramePeriod*0.75)): #most of one frame period left
                ...
                if t >= 0.0 and probe_resp.status == NOT_STARTED:
                    ...
                    event.clearEvents(eventType='keyboard')
                if probe_resp.status == STARTED and t >= (0.0 + (2-win.monitorFramePeriod*0.75)): #most of one frame period left
                ...
                if probe_stim2.status == STARTED and t >= (0.0 + (2-win.monitorFramePeriod*0.75)): #most of one frame period left
