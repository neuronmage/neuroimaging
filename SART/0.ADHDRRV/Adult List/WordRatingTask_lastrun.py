...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Tue Sep 22 13:17:35 2015
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Volumes/MANDY/ADHD:RRV/WordRatingTask.psyexp',
...
word_loop = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=u'/Volumes/MANDY/ADHD:RRV/WordRatingTask.psyexp',
