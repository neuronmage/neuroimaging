...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Tue Sep 22 09:44:08 2015
...
expName = u'WordRatingTask'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/amanda_renfro3/Google Drive/FIU - PhD/MaD Lab/ADHD:RRV/Isabel - Children List/WordTask_Kids.psyexp',
...
instructions1 = visual.TextStim(win=win, ori=0, name='instructions1',
    text=u'Some words have the ability to remind us about ourselves and our day-to-day life, and these are known as \u201cself-referencing\u201d words. \nIn this experiment, you will be asked to rate 800 individual words on the following scale according to how \u201cself- referencing\u201d you believe most people would find each word:\n \n 1 = \u201cNot At All\u201d to 5 = \u201cVery\u201d  \n\nUse the mouse to select your answer on the sliding response scale then confirm your response by clicking the button below.\n\nPlease hit the space bar when you are ready to begin.\n',    font='Arial',
...
word_present = visual.TextStim(win=win, ori=0, name='word_present',
    ...
    color='white', colorSpace='rgb', opacity=1,
    depth=0.0)
rating = visual.RatingScale(win=win, name='rating', marker='triangle', size=1.5, pos=[0.0, -0.4], choices=[u'1', u'2', u'3', u'4', u'5'], tickHeight=-1)
...
word_loop = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=u'/Users/amanda_renfro3/Google Drive/FIU - PhD/MaD Lab/ADHD:RRV/Isabel - Children List/WordTask_Kids.psyexp',
    trialList=data.importConditions(u'KidWordList.xlsx'),
