...
- python wmaze_lvl1.py -s WMAZE_001
                       -o /home/data/madlab/data/mri/wmaze/scndlvl/wmaze_MRthesis/fixed_only/model1
                       -w /home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_only/model1/status/grp_lvl
...
# Array containing all 5 contrasts
...
work_dir = '/scratch/madlab/wmaze/grplvl/wmaze_MRthesis/fixed_only/model1/'
...
datasource.inputs.field_template = dict(copes = 'norm_stats/MRthesis_norm_stats/fixed_only/model1/%s/norm_copes/cope_%s_trans.nii.gz',
                                        varcopes = 'norm_stats/MRthesis_norm_stats/fixed_only/model1/%s/norm_varcopes/varcope_%s_trans.nii.gz')
...
group_randomise_sinker.inputs.base_directory = '/home/data/madlab/data/mri/wmaze/grplvl/grplvl_randomise_exhaustive/fixed_only/MRthesis_z3.07/model1'
