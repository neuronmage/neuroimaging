...
===========================================================
Norm stats workflow for UM GE 750 wmaze task data
...
- python wmaze_lvl1.py -s WMAZE_001
                       ...
                       -w /home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_only/model1/status/norm_stats
...
work_dir = '/scratch/madlab/crash/wmaze_MRthesis/fixed_only/model1/norm_stats'
# Where the output will go
sink_dir = '/home/data/madlab/data/mri/wmaze/norm_stats/MRthesis_norm_stats/fixed_only/model1/'
...
datasource_norm.inputs.field_template = dict(copes = 'scndlvl/wmaze_MRthesis/fixed_only/model1/%s/fixedfx/cope*.nii.gz',
                                             varcopes = 'scndlvl/wmaze_MRthesis/fixed_only/model1/%s/fixedfx/varcope*.nii.gz',
