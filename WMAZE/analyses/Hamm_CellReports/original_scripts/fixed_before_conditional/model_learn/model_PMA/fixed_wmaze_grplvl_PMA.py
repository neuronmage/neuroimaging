...
- python wmaze_grplvl.py -s WMAZE_001
                         -o /home/data/madlab/data/mri/wmaze/grp_lvl/MRthesis_norm_stats/fixed_before_conditional/model_fixed_PMA/
                         -w /scratch/madlab/crash/wmaze_MRthesis/fixed_before_conditional/model_fixed_PMA/grp_lvl
...
work_dir = '/scratch/madlab/wmaze/grplvl/wmaze_MRthesis/fixed_before_conditional/model_fixed_PMA/grp_lvl'
...
datasource.inputs.field_template = dict(copes = 'norm_stats/MRthesis_norm_stats/fixed_before_conditional/model_fixed_PMA/%s/norm_copes/cope_%s_trans.nii.gz',
                                        varcopes = 'norm_stats/MRthesis_norm_stats/fixed_before_conditional/model_fixed_PMA/%s/norm_varcopes/varcope_%s_trans.nii.gz')
...
group_randomise_sinker.inputs.base_directory = '/home/data/madlab/data/mri/wmaze/grplvl/grplvl_MRthesis_randomise/model_fixed_PMA'
