...
- WMAZE Model Learn Version 1 (Binned based on the learning curve)
  ...
  - EV directory (Model Learn1) --- /home/data/madlab/data/mri/wmaze/scanner_behav/WMAZE_001/MRthesis/model_PMA-slope


- python wmaze_lvl1.py -s WMAZE_001
                       -o /home/data/madlab/data/mri/wmaze/frstlvl/wmaze_MRthesis/fixed_before_conditional/model_PMA-slope
                       -w /home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_before_conditional/model_PMA-slope/status/lvl1
...
def subjectinfo(subject_id):
    ...
    data_PMA_pmod = np.genfromtxt(base_proj_dir + 
                                       '/{0}/MRthesis/model_PMA-slope/EVs/set{1}_fixed_mod.txt'.format(subject_id, curr_set), dtype = str)

    data_PMA_event = np.genfromtxt(base_proj_dir + 
                                       '/{0}/MRthesis/model_PMA-slope/EVs/set{1}_fixed_event.txt'.format(subject_id, curr_set), dtype = str)
    
    data_all_remaining = np.genfromtxt(base_proj_dir + 
                                       '/{0}/MRthesis/model_PMA-slope/EVs/set{1}_all_remaining_FB4C.txt'.format(subject_id, curr_set), dtype = str)  
...
if __name__ == "__main__":
    ...
    wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/wmaze_MRthesis/model_fixed_PMA-slope/lvl1/3'
