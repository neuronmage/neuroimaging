...
"""
=========================================================================
wmaze_fMRI: Mandy Thesis -- Fixed before Conditional -- Model Fixed Curve
=========================================================================
...
- WMAZE Model 3 Version Learn1 
  ...
  - EV directory (Model 3) --- /home/data/madlab/data/mri/wmaze/scanner_behav/WMAZE_001/MRthesis/model_fixed_PMA-slope


- python norm_stats.py -s WMAZE_001
                         -o /home/data/madlab/data/mri/wmaze/norm_stats/MRthesis_norm_stats/fixed_before_conditional/model_fixed_PMA-slope
                         -w /scratch/madlab/crash/wmaze_MRthesis/fixed_before_conditional/model_fixed_PMA-slope/norm_stats
...
work_dir = '/scratch/madlab/crash/wmaze_MRthesis/fixed_before_conditional/model_fixed_PMA-slope/norm_stats'
# Where the output will go
sink_dir = '/home/data/madlab/data/mri/wmaze/norm_stats/MRthesis_norm_stats/fixed_before_conditional/model_fixed_PMA-slope'
...
datasource_norm.inputs.field_template = dict(copes = 'scndlvl/wmaze_MRthesis/fixed_before_conditional/model_fixed_PMA-slope/%s/fixedfx/cope*.nii.gz',
                                             varcopes = 'scndlvl/wmaze_MRthesis/fixed_before_conditional/model_fixed_PMA-slope/%s/fixedfx/varcope*.nii.gz',
