...
"""
==============================================================================
wmaze_fMRI: Mandy Thesis -- Fixed before Conditional -- Model fixed_curve
==============================================================================
Group level (Random Effects) workflow for UM GE 750 wmaze task data.

- WMAZE Model fixed_curve 
  - Use FSL ROI to recreate EPI data, removing last 3 volumes
  - Removed last 3 trials before EV creation
  - EV directory (Model 3) --- /home/data/madlab/data/mri/wmaze/scanner_behav/WMAZE_001/MRthesis/model_fixed_curve


- python wmaze_grplvl.py -s WMAZE_001
                         -o /home/data/madlab/data/mri/wmaze/grp_lvl/MRthesis_norm_stats/fixed_before_conditional/model_fixed_curve/
                         -w /scratch/madlab/crash/wmaze_MRthesis/fixed_before_conditional/model_learn1/grp_lvl
...
work_dir = '/scratch/madlab/wmaze/grplvl/mandy_crash/fixed_before_conditional/model_fixed_curve/grp_lvl'


contrasts = ['AllVsBase', 'all_remaining', 
             'fixed_bin1', 'fixed_bin2', 'fixed_bin3',   
...
sids = ['WMAZE_001', 'WMAZE_002', 'WMAZE_004', 'WMAZE_005', 'WMAZE_006',   
        'WMAZE_007', 'WMAZE_008', 'WMAZE_009', 'WMAZE_012',  
        'WMAZE_017', 'WMAZE_018', 'WMAZE_019', 
        'WMAZE_022', 'WMAZE_024', 'WMAZE_026', 'WMAZE_027']
#removed 010 (no Bin 3 in any set)
#removed 020, 021, and 023 (no Bin 1 in any set)
...
datasource.inputs.field_template = dict(copes = 'norm_stats/MRthesis_norm_stats/fixed_before_conditional/model_fixed_curve/%s/norm_copes/cope_%s_trans.nii.gz',
                                        varcopes = 'norm_stats/MRthesis_norm_stats/fixed_before_conditional/model_fixed_curve/%s/norm_varcopes/varcope_%s_trans.nii.gz')
...
group_randomise_sinker.inputs.base_directory = '/home/data/madlab/data/mri/wmaze/grplvl/grplvl_MRthesis_randomise/model_fixed_curve'
