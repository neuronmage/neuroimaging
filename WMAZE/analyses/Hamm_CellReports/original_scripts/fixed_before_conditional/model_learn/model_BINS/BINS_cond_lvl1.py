...
"""
=============================================================================
wmaze_fMRI: Mandy Thesis -- Fixed before Conditional -- Model Curve Version 1
=============================================================================
...
- WMAZE Model Learn Version 1 (Binned based on the learning curve)
  ...
  - EV directory (Model Learn1) --- /home/data/madlab/data/mri/wmaze/scanner_behav/WMAZE_001/MRthesis/model_curve


- python wmaze_lvl1.py -s WMAZE_001
                       -o /home/data/madlab/data/mri/wmaze/frstlvl/wmaze_MRthesis/fixed_before_conditional/model_curve
                       -w /home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_before_conditional/model_curve/status/lvl1
...
def subjectinfo(subject_id):
    ...
    data_curve_bin1 = np.genfromtxt(base_proj_dir + 
                                       '/{0}/MRthesis/model_curve/EVs/set{1}_cond_bin_1.txt'.format(subject_id, curr_set), dtype = str)

    data_curve_bin2 = np.genfromtxt(base_proj_dir + 
                                       '/{0}/MRthesis/model_curve/EVs/set{1}_cond_bin_2.txt'.format(subject_id, curr_set), dtype = str)
 
    data_curve_bin3 = np.genfromtxt(base_proj_dir + 
                                       '/{0}/MRthesis/model_curve/EVs/set{1}_cond_bin_3.txt'.format(subject_id, curr_set), dtype = str)
    
    data_all_remaining = np.genfromtxt(base_proj_dir + 
                                       '/{0}/MRthesis/model_curve/EVs/set{1}_all_remaining_COND.txt'.format(subject_id, curr_set), dtype = str)  

 
    sequence = ['bin1', 'bin2', 'bin3']
    for curr_type in sequence:
        array_name = eval('data_curve_{0}'.format(curr_type))
        if array_name.size == 3: #ONLY ONE TRIAL 
	    curr_names = ['curve_{0}'.format(curr_type)]
...
def get_contrasts(subject_id, info):
    ...
    if 'curve_bin1' in j.conditions and 'curve_bin2' in j.conditions:
        cont_bin1_vs_bin2 = ['bin1_minus_bin2', 'T', ['curve_bin1','curve_bin2'], [1, -1]]
        cont_bin2_vs_bin1 = ['bin2_minus_bin1', 'T', ['curve_bin2','curve_bin1'], [1, -1]]
        contrasts.append(cont_bin1_vs_bin2)
        contrasts.append(cont_bin2_vs_bin1)
    if 'curve_bin1' in j.conditions and 'curve_bin3' in j.conditions:
        cont_bin1_vs_bin3 = ['bin1_minus_bin3', 'T', ['curve_bin1','curve_bin3'], [1, -1]]
        cont_bin3_vs_bin1 = ['bin3_minus_bin1', 'T', ['curve_bin3','curve_bin1'], [1, -1]]
        contrasts.append(cont_bin1_vs_bin3)
        contrasts.append(cont_bin3_vs_bin1)
    if 'curve_bin2' in j.conditions and 'curve_bin3' in j.conditions:
        cont_bin2_vs_bin3 = ['bin2_minus_bin3', 'T', ['curve_bin2','curve_bin3'], [1, -1]]
        cont_bin3_vs_bin2 = ['bin3_minus_bin2', 'T', ['curve_bin3','curve_bin2'], [1, -1]]
...
if __name__ == "__main__":
    ...
    wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/wmaze_MRthesis/model_cond_curve/lvl1/3'
