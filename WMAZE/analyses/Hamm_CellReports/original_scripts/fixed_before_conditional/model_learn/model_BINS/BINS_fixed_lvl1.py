...
"""
================================================
Fixed before Conditional -- Model Bins Version 1
================================================
...
- WMAZE Model Learn Version 1 (Binned based on the learning curve)
  ...
  - EV directory (Model Learn1) --- /home/data/madlab/data/mri/wmaze/scanner_behav/WMAZE_001/model_BINS


- python wmaze_lvl1.py -s WMAZE_001
                       -o /home/data/madlab/data/mri/wmaze/frstlvl/model_BINS
                       -w /scratch/madlab/crash/mandy_crash/model_BINS/lvl1
...
def subjectinfo(subject_id):
    ...
    data_bin1 = np.genfromtxt(base_proj_dir + '/{0}/model_BINS/set{1}_fixed_bin1.txt'.format(subject_id, curr_set), dtype = str)
    data_bin2 = np.genfromtxt(base_proj_dir + '/{0}/model_BINS/set{1}_fixed_bin2.txt'.format(subject_id, curr_set), dtype = str) 
    data_bin3 = np.genfromtxt(base_proj_dir + '/{0}/model_BINS/set{1}_fixed_bin3.txt'.format(subject_id, curr_set), dtype = str)    
...
def get_contrasts(subject_id, info):
    ...
    if 'bin1' in j.conditions and 'bin2' in j.conditions:
        cont_bin1_vs_bin2 = ['bin1_minus_bin2', 'T', ['bin1','bin2'], [1, -1]]
        cont_bin2_vs_bin1 = ['bin2_minus_bin1', 'T', ['bin2','bin1'], [1, -1]]
        contrasts.append(cont_bin1_vs_bin2)
        contrasts.append(cont_bin2_vs_bin1)
    if 'bin1' in j.conditions and 'bin3' in j.conditions:
        cont_bin1_vs_bin3 = ['bin1_minus_bin3', 'T', ['bin1','bin3'], [1, -1]]
        cont_bin3_vs_bin1 = ['bin3_minus_bin1', 'T', ['bin3','bin1'], [1, -1]]
        contrasts.append(cont_bin1_vs_bin3)
        contrasts.append(cont_bin3_vs_bin1)
    if 'bin2' in j.conditions and 'bin3' in j.conditions:
        cont_bin2_vs_bin3 = ['bin2_minus_bin3', 'T', ['bin2','bin3'], [1, -1]]
        cont_bin3_vs_bin2 = ['bin3_minus_bin2', 'T', ['bin3','bin2'], [1, -1]]
...
if __name__ == "__main__":
    ...
    if args.work_dir:
        ...
        work_dir = os.getcwd()
    wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/mandy_crash/model_BINS/lvl1/1'
