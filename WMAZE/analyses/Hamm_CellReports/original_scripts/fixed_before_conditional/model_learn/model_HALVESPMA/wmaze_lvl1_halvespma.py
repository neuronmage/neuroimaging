...
def subjectinfo(subject_id):
    ...
    data_early_learn_event = np.genfromtxt(base_proj_dir + 
                                           '/{0}/MRthesis/model_HALVESPMA/set{1}_early_learn_event.txt'.format(subject_id, curr_set), dtype = str)

    data_late_learn_event = np.genfromtxt(base_proj_dir + 
                                          '/{0}/MRthesis/model_HALVESPMA/set{1}_late_learn_event.txt'.format(subject_id, curr_set), dtype = str)

    data_early_nonlearn_event = np.genfromtxt(base_proj_dir + 
                                              '/{0}/MRthesis/model_HALVESPMA/set{1}_early_nonlearn_event.txt'.format(subject_id, curr_set), dtype = str)

    data_late_nonlearn_event = np.genfromtxt(base_proj_dir + 
                                             '/{0}/MRthesis/model_HALVESPMA/set{1}_late_nonlearn_event.txt'.format(subject_id, curr_set), dtype = str)

    data_early_learn_pmod = np.genfromtxt(base_proj_dir + 
                                          '/{0}/MRthesis/model_HALVESPMA/set{1}_early_learn_pmod.txt'.format(subject_id, curr_set), dtype = str)

    data_late_learn_pmod = np.genfromtxt(base_proj_dir + 
                                         '/{0}/MRthesis/model_HALVESPMA/set{1}_late_learn_pmod.txt'.format(subject_id, curr_set), dtype = str)

    data_early_nonlearn_pmod = np.genfromtxt(base_proj_dir + 
                                             '/{0}/MRthesis/model_HALVESPMA/set{1}_early_nonlearn_pmod.txt'.format(subject_id, curr_set), dtype = str)

    data_late_nonlearn_pmod = np.genfromtxt(base_proj_dir + 
                                            '/{0}/MRthesis/model_HALVESPMA/set{1}_late_nonlearn_pmod.txt'.format(subject_id, curr_set), dtype = str)
 
    data_all_remaining = np.genfromtxt(base_proj_dir + 
                                       '/{0}/MRthesis/model_HALVESPMA/set{1}_all_remaining.txt'.format(subject_id, curr_set), dtype = str)  
