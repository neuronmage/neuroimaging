...
For example:
  python wmaze_lvl1_modelLSS_atm12292017.py -s WMAZE_001
                                            -o /home/data/madlab/data/mri/wmaze/frstlvl/wmaze_MRthesis/fixed_before_conditional/modelLSS_MR_drop3
                                            -w /scratch/madlab/wmaze/anal_MR_thesis/fixed_before_conditional/modelLSS_MR_drop3/lvl1
...
def subjectinfo(subject_id):
    ...
    for curr_run in range(1,7):
        ...
        data_FX_before_COND_corr = np.genfromtxt(base_proj_dir + 
                                                 '/{0}/MRthesis/modelLSS_drop3/EVs/run{1}_all_before_B_corr.txt'.format(subject_id,
                                                                                                                curr_run), 
                                                                                                                dtype = str)
        ...
        data_FX_before_COND_incorr = np.genfromtxt(base_proj_dir + 
                                                   '/{0}/MRthesis/modelLSS_drop3/EVs/run{1}_all_before_B_incorr.txt'.format(subject_id,
                                                                                                                    curr_run), 
                                                                                                                    dtype = str)
        # Variable to store all remaining responses in the current run
        data_all_remaining = np.genfromtxt(base_proj_dir + 
                                           '/{0}/MRthesis/modelLSS_drop3/EVs/run{1}_all_remaining.txt'.format(subject_id,
                                                                                                      curr_run), 
                                                                                                      dtype = str)
...
if __name__ == "__main__":
    ...
    wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/wmaze_MRthesis/modelLSS_drop3'
