...
for sub in sids:
    ...
    convertcmd = ' '.join(['python', '/home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_before_conditional/modelLSS/merge_copes_modelLSS_MR_drop3.py', '-s', sub, '-o', outdir, '-w', workdir])
