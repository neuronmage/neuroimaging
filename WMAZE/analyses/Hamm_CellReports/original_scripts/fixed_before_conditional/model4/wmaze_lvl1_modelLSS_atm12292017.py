...
For example:
  python wmaze_lvl1_modelLSS_atm12292017.py -s WMAZE_001
                                            -o /home/data/madlab/data/mri/wmaze/frstlvl/wmaze_MRthesis/fixed_before_conditional/modelLSS
                                            -w /scratch/madlab/wmaze/anal_MR_thesis/fixed_before_conditional/modelLSS/lvl1
...
def subjectinfo(subject_id):
    ...
    for curr_run in range(1,7):
        ...
        if data_A_before_B_incorr.size > 0 and data_C_before_B_incorr.size > 0:
            orig_all_fixed_b4_cond_data = {'A_before_B_corr': data_A_before_B_corr, 
                                           'A_before_B_incorr': data_A_before_B_incorr,
                                           'C_before_B_corr': data_C_before_B_corr,
                                           'C_before_B_incorr': data_C_before_B_incorr}
        elif data_A_before_B_incorr.size > 0 and data_C_before_B_incorr.size == 0:
            orig_all_fixed_b4_cond_data = {'A_before_B_corr': data_A_before_B_corr,
                                           'A_before_B_incorr': data_A_before_B_incorr,
                                           'C_before_B_corr': data_C_before_B_corr}
        elif data_A_before_B_incorr.size == 0 and data_C_before_B_incorr.size > 0:
        ...
        for curr_key in orig_all_fixed_b4_cond_data.keys():
            ...
            if curr_condition_data.size == 3: # ONLY ONE EVENT OF THIS CONDITION DURING THIS RUN
                ...
                for curr_cond_trl in range(len(curr_condition_data)):
                    ...
                    # ISOLATE THE REMIANING TRIALS FOR THE CURRENT CONDITION USING THE NUMPY DELETE FUNCTION
