...
"""
=============================================================================
wmaze_fMRI: Mandy Thesis -- Fixed before Conditional -- Model 5 Version 2.3.1
=============================================================================
First level workflow for UM GE 750 wmaze task data

- WMAZE Model 5 Version 2.3.1
  - LSS model -- Beta series correlation analysis
  - Statistically account for last three volumes via statistical modeling
...
- python wmaze_lvl1_model5LSS_orig_3-1.py -s WMAZE_001
                                          -o /home/data/madlab/data/mri/wmaze/frstlvl/wmaze_MRthesis/fixed_before_conditional/model5_2-3-1
                                          -w /scratch/madlab/wmaze/anal_MR_thesis/fixed_before_conditional/model5_2-3-1/lvl1
...
def subjectinfo(subject_id):
    ...
    for curr_run in range(1,7):
        ...
        # Variable to store all remaining responses in the current run
        data_all_last3 = np.genfromtxt(base_proj_dir + 
...
if __name__ == "__main__":
    ...
    wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/wmaze_MRthesis/model5LSS_orig_3-1'
