...
- python norm_stats.py -s WMAZE_001
                       -o /home/data/madlab/data/mri/wmaze/norm_stats/wmaze_MRthesis/fixed_before_conditional/model5_1-3-1
                       -w /home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_before_conditional/model5/model5_1-3-1/status/norm_stats
...
work_dir = '/home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_before_conditional/model5/model5_1-3-1/status/norm_stats'
# Where the output will go
sink_dir = '/home/data/madlab/data/mri/wmaze/norm_stats/MRthesis_norm_stats/fixed_before_conditional/model5_1-3-1/'
...
#### subj_iterable (subject_id) ----> fs_skullstrip_wf (inputspec.subject_id)
...
datasource_norm.inputs.field_template = dict(copes = 'scndlvl/wmaze_MRthesis/fixed_before_conditional/model5_1-3-1/%s/fixedfx/cope*.nii.gz',
                                             varcopes = 'scndlvl/wmaze_MRthesis/fixed_before_conditional/model5_1-3-1/%s/fixedfx/varcope*.nii.gz',
...
convert2itk = Node(C3dAffineTool(), 
                   name = 'convert2itk')
# Transform to ITK format (Boolean)
...
#### datasource_norm (bbreg_xfm) ----> convert2itk (transform_file)
#### datasource_norm (mean_img) ----> convert2itk (source_file)
...
#### convert2itk (itk_transform) ----> merge_xfm (in2)
#### datasource_norm (ants_warp) ----> merge_xfm (in1)
...
#### datasource_norm (copes) ----> cope2targ (input_image)
#### merge_xfm (out) ----> cope2targ (transforms)
...
#### datasource_norm (varcopes) ----> varcope2targ (input_image)
#### merge_xfm (out) ----> varcope2targ (transforms)
