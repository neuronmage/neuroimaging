...
Group level (Random Effects) workflow for UM GE 750 wmaze task data.
 ...
 1 - Statistically account for last three volumes via statistical modeling
  ...
  python wmaze_grplvl.py -s WMAZE_001
                       -o /home/data/madlab/data/mri/wmaze/grplvl/wmaze_MRthesis/fixed_before_conditional/model5_1-3-1
                       -w /home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_before_conditional/model5/model5_1-3-1/status/grp_lvl
...
work_dir = '/home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_before_conditional/model5/model5_1-3-1/status/grp_lvl'
...
datasource.inputs.field_template = dict(copes = 'norm_stats/MRthesis_norm_stats/fixed_before_conditional/model5_1-3-1/%s/norm_copes/cope_%s_trans.nii.gz',
                                        varcopes = 'norm_stats/MRthesis_norm_stats/fixed_before_conditional/model5_1-3-1/%s/norm_varcopes/varcope_%s_trans.nii.gz')
...
group_randomise_sinker.inputs.base_directory = '/home/data/madlab/data/mri/wmaze/grplvl/grplvl_randomise_exhaustive/MRthesis_z3.07/model5_1-3-1'
...
group_sinker.inputs.base_directory = '/home/data/madlab/data/mri/wmaze/grplvl/grplvl_MRthesis_z3.07/fixed_before_conditional/model5_1-3-1'
