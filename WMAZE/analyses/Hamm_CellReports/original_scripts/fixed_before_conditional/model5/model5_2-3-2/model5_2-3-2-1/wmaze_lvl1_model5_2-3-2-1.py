...
"""
===============================================================================
wmaze_fMRI: Mandy Thesis -- Fixed before Conditional -- Model 5 Version 2.3.2.1
===============================================================================
First level workflow for UM GE 750 wmaze task data

- WMAZE Model 5 Version 2.3.2.1
...
1  - EV directory (Model 5 - all21) --- /home/data/madlab/data/mri/wmaze/scanner_behav/WMAZE_001/MRthesis/model5_2-3-2-1


- python wmaze_lvl1_model5_2-3-2-1.py -s WMAZE_001
                       -o /home/data/madlab/data/mri/wmaze/frstlvl/wmaze_MRthesis/fixed_before_conditional/model5_2-3-2-1
                       -w /home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_before_conditional/model5/model5_2-3-2-1/status/lvl1
...
def subjectinfo(subject_id):
    ...
    for curr_set in range(1,4):
        ...
        data_FX_before_COND_corr = np.genfromtxt(base_proj_dir + 
                                                 '/{0}/MRthesis/model5_2-3-2-1/EVs/set{1}_all21_FX_before_COND_corr.txt'.format(subject_id,
                                                                                                                                curr_set), 
                                                                                                                                dtype = str)
        ...
        data_FX_before_COND_incorr = np.genfromtxt(base_proj_dir + 
                                                   '/{0}/MRthesis/model5_2-3-2-1/EVs/set{1}_all21_FX_before_COND_incorr.txt'.format(subject_id,
                                                                                                                                    curr_set), 
                                                                                                                                    dtype = str)
        # Variable to store all remaining responses in the current run
        data_all_remaining = np.genfromtxt(base_proj_dir + 
                                           '/{0}/MRthesis/model5_2-3-2-1/EVs/set{1}_all21_all_remaining.txt'.format(subject_id,
                                                                                                                    curr_set), 
                                                                                                                    dtype = str)
...
def firstlevel_wf(subject_id,
    ...
    #### datasource (task_mri_files) ----> fslroi_epi (in_file)
    ...
    #### motionnoise (subjinfo) ----> expand_epi_files (subjinfo)
    #### fslroi (roi_file) ----> expand_epi_files (in_files)
    ...
    #### expand_epi_files (files_expanded) ----> specify_model (functional_runs)
...
if __name__ == "__main__":
    ...
    wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/wmaze_MRthesis/model5_2-3-2'
