...
============================================================================================
Very simple Nipype script to merge beta series copes from wmaze_lvl1_model5_2-3-2.py
...
- python merge_copes_model5_2-3-2-1.py -s WMAZE_001
                                     -o /home/data/madlab/data/mri/wmaze/frstlvl/wmaze_MRthesis/fixed_before_conditional/model5_2-3-2-1/merge_copes
                                     -w /home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_before_conditional/model5/model5_2-3-2-1/status/merge_copes
"""
...
def cope_merge_wf(subject_id, 
	...
	dsource.inputs.base_directory = os.path.abspath('/home/data/madlab/data/mri/wmaze/frstlvl/wmaze_MRthesis/fixed_before_conditional/model5_2-3-2-1/')
	dsource.inputs.field_template = dict(corr_cope = '%s/modelfit/contrasts/_estimate_model*/cope*_FX_before_COND_corr_set*_trl*.nii.gz',
				             incorr_cope = '%s/modelfit/contrasts/_estimate_model*/cope*_FX_before_COND_incorr_set*_trl*.nii.gz')
...
def create_workflow(args, 
                    name = 'model5_2-3-2-1_merge_copes'):
...
if __name__ == "__main__":
	...
	parser = ArgumentParser(description =__doc__)
    	...
    	wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/wmaze_MRthesis/model5_2-3-2-1/merge_copes'
