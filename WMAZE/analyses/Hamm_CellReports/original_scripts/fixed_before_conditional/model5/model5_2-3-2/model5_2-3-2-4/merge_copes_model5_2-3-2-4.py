...
============================================================================================
Very simple Nipype script to merge beta series copes from wmaze_lvl1_model5_2-3-2-4.py

- WMAZE Model 5 Version 2.3.2.4
...
4  - Model 5 - 11/11 window


- python merge_copes_model5_2-3-2.py -s WMAZE_001
                                     -o /home/data/madlab/data/mri/wmaze/frstlvl/wmaze_MRthesis/fixed_before_conditional/model5_2-3-2/merge_copes
                                     -w /home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_before_conditional/model5/model5_2-3-2/status/merge_copes
"""
...
def cope_merge_wf(subject_id, 
	...
	dsource.inputs.base_directory = os.path.abspath('/home/data/madlab/data/mri/wmaze/frstlvl/wmaze_MRthesis/fixed_before_condional/model5_2-3-2-4')
	dsource.inputs.field_template = dict(during11_cope = '%s/learning_window/*.nii.gz',
				             after11_cope = '%s/after_window/*.nii.gz')
...
def create_workflow(args, 
                    name = 'model5_2-3-2-4_merge_copes'):
...
if __name__ == "__main__":
	...
	parser = ArgumentParser(description =__doc__)
    	...
    	wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/wmaze_MRthesis/model5_2-3-2-4/merge_copes'
