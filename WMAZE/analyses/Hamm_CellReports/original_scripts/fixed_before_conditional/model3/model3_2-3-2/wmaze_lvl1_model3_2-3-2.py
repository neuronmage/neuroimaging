...
"""
=============================================================================
wmaze_fMRI: Mandy Thesis -- Fixed before Conditional -- Model 3 Version 2.3.2
=============================================================================
First level workflow for UM GE 750 wmaze task data

- WMAZE Model 3 Version 2.3.2
...
2  - EV directory (Model 3) --- /home/data/madlab/data/mri/wmaze/scanner_behav/WMAZE_001/MRthesis/model3_1-3-2


- python wmaze_lvl1.py -s WMAZE_001
                       -o /home/data/madlab/data/mri/wmaze/frstlvl/wmaze_MRthesis/fixed_before_conditional/model3_2-3-2
                       -w /home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_before_conditional/model3/model3_2-3-2/status/lvl1
...
def subjectinfo(subject_id):
    ...
    for curr_run in range(1,7):
        ...
        data_FX_before_COND_corr = np.genfromtxt(base_proj_dir + 
                                                 '/{0}/MRthesis/model3_1-3-2/EVs/run{1}_all_before_B_corr.txt'.format(subject_id,
                                                                                                                      curr_run), 
                                                                                                                      dtype = str)
        ...
        data_FX_before_COND_incorr = np.genfromtxt(base_proj_dir + 
                                                   '/{0}/MRthesis/model3_1-3-2/EVs/run{1}_all_before_B_incorr.txt'.format(subject_id,
                                                                                                                          curr_run), 
                                                                                                                          dtype = str)
        # Variable to store all remaining responses in the current run
        data_all_remaining = np.genfromtxt(base_proj_dir + 
                                           '/{0}/MRthesis/model3_1-3-2/EVs/run{1}_all_remaining.txt'.format(subject_id,
                                                                                                            curr_run), 
                                                                                                            dtype = str)
...
if __name__ == "__main__":
    ...
    wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/wmaze_MRthesis/model3_2-3-2'
