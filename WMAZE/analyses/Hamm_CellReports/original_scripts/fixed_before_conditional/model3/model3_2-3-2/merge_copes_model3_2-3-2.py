...
For example:
  python model3_merge_copes.py -s WMAZE_001
                                            -o /home/data/madlab/data/mri/wmaze/frstlvl/wmaze_MRthesis/fixed_before_conditional/model3_2-3-2/merge_copes
                                            -w /scratch/madlab/crash/wmaze_MRthesis/model3_2-3-2/merge_copes
"""
...
def cope_merge_wf(subject_id, 
	...
	dsource.inputs.base_directory = os.path.abspath('/home/data/madlab/data/mri/wmaze/frstlvl/wmaze_MRthesis/fixed_before_conditional/model3_2-3-2/')
...
if __name__ == "__main__":
	...
	parser = ArgumentParser(description =__doc__)
    	...
    	wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/wmaze_MRthesis/model3_2-3-2/merge_copes'
