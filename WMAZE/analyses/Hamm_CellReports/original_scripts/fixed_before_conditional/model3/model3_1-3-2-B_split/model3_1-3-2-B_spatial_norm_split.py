...
- WMAZE Model 3 Version 1.3.2 
  ...
  - Split analysis into early and late learning for B trials


- python norm_stats.py -s WMAZE_001
                         -o /home/data/madlab/data/mri/wmaze/norm_stats/MRthesis_norm_stats/fixed_before_conditional/model3_1-3-2-B_split
                         -w /scratch/madlab/crash/wmaze_MRthesis/fixed_before_conditional/model3_1-3-2-B_split/norm_stats
"""
...
work_dir = '/scratch/madlab/crash/wmaze_MRthesis/model3_1-3-2-B_split/norm_stats'
sink_dir = '/home/data/madlab/data/mri/wmaze/norm_stats/MRthesis_norm_stats/fixed_before_conditional/model3_1-3-2-B_split'
...
datasource_norm.inputs.field_template = dict(copes1sthalf = 'scndlvl/wmaze_MRthesis/fixed_before_conditional/model3_1-3-2-B_split/%s/fixedfx1sthalf/cope*.nii.gz',
                                             varcopes1sthalf = 'scndlvl/wmaze_MRthesis/fixed_before_conditional/model3_1-3-2-B_split/%s/fixedfx1sthalf/varcope*.nii.gz',
                                             copes2ndhalf = 'scndlvl/wmaze_MRthesis/fixed_before_conditional/model3_1-3-2-B_split/%s/fixedfx2ndhalf/cope*.nii.gz',
                                             varcopes2ndhalf = 'scndlvl/wmaze_MRthesis/fixed_before_conditional/model3_1-3-2-B_split/%s/fixedfx2ndhalf/varcope*.nii.gz',
