...
def create_freesurfer_skullstrip_workflow(name = 'freesurfer_skullstrip'):
    ...
    #defines all inputs and outputs required for the freesurfer skull stripping workflow
    ...
    # Define the segmentation and original brain to be stripped
    ...
    # Makes a binarized mask of the segmentation file -- 1 where brain, 0 where non-brain
    ...
    # Node to apply the NIFTI mask to the NIFTI brain -- removes non-brain (0) values
