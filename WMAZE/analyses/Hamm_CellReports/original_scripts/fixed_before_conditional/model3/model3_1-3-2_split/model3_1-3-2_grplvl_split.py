...
- python wmaze_grplvl.py -s WMAZE_001
                         -o /home/data/madlab/data/mri/wmaze/grp_lvl/MRthesis_norm_stats/fixed_before_conditional/model3_1-3-2_split/
                         -w /scratch/madlab/crash/wmaze_MRthesis/fixed_before_conditional/model3_1-3-2_split/grp_lvl
...
work_dir = '/scratch/madlab/crash/wmaze_MRthesis/model3_1-3-2_split/grp_lvl/grp_wf'
'''
...
'''
#temp sublist
sids = ['WMAZE_001', 'WMAZE_004', 'WMAZE_008', 'WMAZE_009', 'WMAZE_010',  
        'WMAZE_012', 'WMAZE_017', 'WMAZE_018', 'WMAZE_019', 'WMAZE_021', 
...
datasource.inputs.field_template = dict(copes1sthalf = 'norm_stats/MRthesis_norm_stats/fixed_before_conditional/model3_1-3-2_split/%s/norm_copes/frsthalf/cope_%s_trans.nii.gz',
                                        varcopes1sthalf = 'norm_stats/MRthesis_norm_stats/fixed_before_conditional/model3_1-3-2_split/%s/norm_varcopes/frsthalf/varcope_%s_trans.nii.gz',
                                        copes2ndhalf = 'norm_stats/MRthesis_norm_stats/fixed_before_conditional/model3_1-3-2_split/%s/norm_copes/scndhalf/cope_%s_trans.nii.gz',
                                        varcopes2ndhalf = 'norm_stats/MRthesis_norm_stats/fixed_before_conditional/model3_1-3-2_split/%s/norm_varcopes/scndhalf/varcope_%s_trans.nii.gz')
...
group_randomise_sinker.inputs.base_directory = '/home/data/madlab/data/mri/wmaze/grplvl/grplvl_randomise_exhaustive/MRthesis_z3.07/model3_1-3-2_split'
