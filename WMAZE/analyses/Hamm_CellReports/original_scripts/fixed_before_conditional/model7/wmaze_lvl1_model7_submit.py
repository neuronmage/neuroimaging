...
workdir = '/scratch/madlab/crash/wmaze_MRthesis/model7/lvl1'
outdir = '/home/data/madlab/data/mri/wmaze/frstlvl/wmaze_MRthesis/fixed_before_conditional/model7'
...
for i, sid in enumerate(subjs):
    ...
    convertcmd = ' '.join(['python', '/home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_before_conditional/model7/wmaze_lvl1_model7.py', '-s', sid, '-o', outdir, '-w', workdir])
    
    # The shell file for each subject
    script_file = 'wmaze_lvl1_model7-{0}.sh'.format(sid)
    ...
    outcmd = 'bsub -J atm-wmaze_lvl1_model7-{0} -q PQ_madlab -e /scratch/madlab/crash/wmaze_MRthesis/model7/lvl1/err_{0} -o /scratch/madlab/crash/wmaze_MRthesis/model7/lvl1/out_{0} < {1}'.format(sid, script_file)
