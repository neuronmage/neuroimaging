...
- python norm_stats.py -s WMAZE_001
                         -o /home/data/madlab/data/mri/wmaze/norm_stats/MRthesis_norm_stats/fixed_before_conditional/model7
                         -w /scratch/madlab/crash/wmaze_MRthesis/fixed_before_conditional/model7
...
work_dir = '/scratch/madlab/crash/wmaze_MRthesis/fixed_before_conditional/model7/norm_stats'
# Where the output will go
sink_dir = '/home/data/madlab/data/mri/wmaze/norm_stats/MRthesis_norm_stats/fixed_before_conditional/model7'
...
datasource_norm.inputs.field_template = dict(copes = 'scndlvl/wmaze_MRthesis/fixed_before_conditional/model7/%s/fixedfx/cope*.nii.gz',
                                             varcopes = 'scndlvl/wmaze_MRthesis/fixed_before_conditional/model7/%s/fixedfx/varcope*.nii.gz',
