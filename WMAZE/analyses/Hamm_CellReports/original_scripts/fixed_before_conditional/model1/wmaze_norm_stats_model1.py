...
For example::
  ...
  python wmaze_grplvl.py -s WMAZE_001
                       -o /home/data/madlab/data/mri/wmaze/norm_stats/MRthesis_norm_stats/model1/
                       -w /scratch/madlab/crash/wmaze_MRthesis/model1/norm_stats
...
work_dir = '/home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_before_conditional/model1/status/norm_stats'
# Where the output will go
sink_dir = '/home/data/madlab/data/mri/wmaze/norm_stats/MRthesis_norm_stats/fixed_before_conditional/model1/'
...
datasource_norm.inputs.field_template = dict(copes = 'scndlvl/wmaze_MRthesis/fixed_before_conditional/model1/%s/fixedfx/cope*.nii.gz',
                                             varcopes = 'scndlvl/wmaze_MRthesis/fixed_before_conditional/model1/%s/fixedfx/varcope*.nii.gz',
