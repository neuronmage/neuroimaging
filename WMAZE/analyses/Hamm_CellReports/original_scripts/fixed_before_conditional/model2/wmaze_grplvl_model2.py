...
For example::
  ...
  python wmaze_grplvl.py -s WMAZE_001
                       -o /home/data/madlab/data/mri/wmaze/grplvl/wmaze_MRthesis/fixed_before_conditional/model2/
                       -w /scratch/madlab/crash/wmaze_MRthesis/fixed_before_conditional/model2/grp_lvl
...
datasource.inputs.field_template = dict(copes = 'norm_stats/MRthesis_norm_stats/fixed_before_conditional/model2/%s/norm_copes/cope_%s_trans.nii.gz',
                                        varcopes = 'norm_stats/MRthesis_norm_stats/fixed_before_conditional/model2/%s/norm_varcopes/varcope_%s_trans.nii.gz')
...
group_sinker.inputs.base_directory = '/home/data/madlab/data/mri/wmaze/grplvl/grplvl_MRthesis_z3.07/fixed_before_conditional/model2'
