...
For example:
  python wmaze_lvl1.py -s WMAZE_001
                       -o /home/data/madlab/data/mri/wmaze/frstlvl/wmaze_MRthesis/fixed_before_conditional/model2
                       -w /home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_before_conditional/model2/status/lvl1
...
def subjectinfo(subject_id):
    ...
    for curr_run in range(1,7):
        ...
        data_A_before_B_corr = np.genfromtxt(base_proj_dir + 
                                            '/{0}/MRthesis/model2/EVs/run{1}_A_before_B_corr.txt'.format(subject_id,
                                                                                                         curr_run), 
                                                                                                         dtype = str)
        ...
        data_A_before_B_incorr = np.genfromtxt(base_proj_dir + 
                                              '/{0}/MRthesis/model2/EVs/run{1}_A_before_B_incorr.txt'.format(subject_id,
                                                                                                             curr_run), 
                                                                                                             dtype = str)
        ...
        data_C_before_B_corr = np.genfromtxt(base_proj_dir + 
                                            '/{0}/MRthesis/model2/EVs/run{1}_C_before_B_corr.txt'.format(subject_id,
                                                                                                         curr_run), 
                                                                                                         dtype = str)
        ...
        data_C_before_B_incorr = np.genfromtxt(base_proj_dir + 
                                              '/{0}/MRthesis/model2/EVs/run{1}_C_before_B_incorr.txt'.format(subject_id,
                                                                                                             curr_run), 
                                                                                                             dtype = str)
        '''
        with open('/home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_before_conditional/model2/bleh2_run{0}.txt'.format(curr_run), 'w') as bleh2:
        ...
        data_all_remaining = np.genfromtxt(base_proj_dir + 
                                           '/{0}/MRthesis/model2/EVs/run{1}_all_remaining.txt'.format(subject_id,
                                                                                                      curr_run), 
                                                                                                      dtype = str)
        ...
        # Append the current sequence/run info
        names.append(curr_names)  
        onsets.append(curr_onsets)
        durations.append(curr_durations)
        amplitudes.append(curr_amplitudes)
...
def get_contrasts(subject_id, info):
    ...
    for i, j in enumerate(info):
        ...
        '''
        with open('/home/data/madlab/scripts/wmaze/anal_MR_thesis/fixed_before_conditional/bleh_{0}.txt'.format(i+1), 'w') as bleh:
...
if __name__ == "__main__":
    ...
    wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/wmaze_MRthesis/model2'
