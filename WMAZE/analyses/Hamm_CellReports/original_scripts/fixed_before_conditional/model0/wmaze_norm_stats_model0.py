...
For example::
  ...
  python wmaze_grplvl.py -s WMAZE_001
                       -o /home/data/madlab/data/mri/wmaze/norm_stats/MRthesis_norm_stats/fb4c/
                       -w /scratch/madlab/crash/wmaze_MRthesis/fb4c/norm_stats
...
work_dir = '/scratch/madlab/crash/wmaze_MRthesis/fb4c/norm_stats'
# Where the output will go
sink_dir = '/home/data/madlab/data/mri/wmaze/norm_stats/MRthesis_norm_stats/fb4c/'

#sids = ['WMAZE_001']

sids = ['WMAZE_002', 'WMAZE_004', 'WMAZE_005', 'WMAZE_006', 'WMAZE_007', 'WMAZE_008', 
...
datasource_norm.inputs.field_template = dict(copes = 'scndlvl/wmaze_MRthesis/fixed_before_condition%s/fixedfx/cope*.nii.gz',
                                             varcopes = 'scndlvl/wmaze_MRthesis/fixed_before_conditional/%s/fixedfx/varcope*.nii.gz',
