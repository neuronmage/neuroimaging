...
For example::
  ...
  python wmaze_grplvl.py -s WMAZE_001
                       -o /home/data/madlab/data/mri/wmaze/grplvl/wmaze_MRthesis/fb4c/
                       -w /scratch/madlab/wmaze/grplvl/wmaze_MRthesis/fb4c/
...
# Array containing all 13 contrasts
contrasts = ['AllVsBase', 'A_before_B_corr', 'A_before_B_incorr', 'C_before_B_corr', 'C_before_B_incorr',
             'all_remaining', 'nonresponse', 'AB_corr_minus_AB_incorr', 'AB_incorr_minus_AB_corr',
             'CB_corr_minus_CB_incorr', 'CB_incorr_minus_CB_corr', 'AC_corr_vs_AC_incorr', 'AC_incorr_vs_AC_corr']

proj_dir = '/home/data/madlab/data/mri/wmaze'
fs_projdir = '/home/data/madlab/surfaces/wmaze'
work_dir = '/scratch/madlab/wmaze/grplvl/wmaze_MRthesis/fb4c/'

# Array containing subject IDs

sids = ['WMAZE_001', 'WMAZE_002', 'WMAZE_004', 'WMAZE_005', 'WMAZE_006', 'WMAZE_007', 'WMAZE_008', 
        'WMAZE_009', 'WMAZE_010', 'WMAZE_012', 'WMAZE_017', 'WMAZE_018', 'WMAZE_019', 
        'WMAZE_020', 'WMAZE_021', 'WMAZE_022', 'WMAZE_023', 'WMAZE_024', 'WMAZE_026', 'WMAZE_027']
...
# Node to iterate through all 22 contrasts
...
datasource.inputs.field_template = dict(copes = 'norm_stats/MRthesis_norm_stats/fb4c/%s/norm_copes/cope_%s_trans.nii.gz',
                                        varcopes = 'norm_stats/MRthesis_norm_stats/fb4c/%s/norm_varcopes/varcope_%s_trans.nii.gz')
...
group_sinker.inputs.base_directory = '/home/data/madlab/data/mri/wmaze/grplvl/grplvl_MRthesis_z3.07/fb4c'
