...
- python PMA_fixed_lvl1.py -s WMAZE_001
                       -o /home/data/madlab/data/mri/wmaze/frstlvl/learning/PMA/fixed
...
def subjectinfo(subject_id):
    ...
    data_event = np.genfromtxt(base_proj_dir + '/{0}/model_PMA/set{1}_fixed_event.txt'.format(subject_id, curr_set), dtype = str)

    data_pmod = np.genfromtxt(base_proj_dir + '/{0}/model_PMA/set{1}_fixed_mod.txt'.format(subject_id, curr_set), dtype = str)
    
    data_all_remaining = np.genfromtxt(base_proj_dir + '/{0}/model_PMA/set{1}_all_remaining_FIXED.txt'.format(subject_id, curr_set), dtype = str)  
...
if __name__ == "__main__":
    ...
    wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/mandy/PMA/fixed/lvl1/3'
