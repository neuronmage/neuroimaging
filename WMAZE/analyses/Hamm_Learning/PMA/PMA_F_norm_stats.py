...
- python norm_stats.py -s WMAZE_001
  			 -o /home/data/madlab/data/mri/wmaze/norm_stats/learning/PMA/fixed
                         -w /scratch/madlab/crash/mandy/learning/PMA/fixed/norm_stats 
"""
...
work_dir = '/scratch/madlab/crash/mandy/learning/PMA/fixed/norm_stats'
sink_dir = '/home/data/madlab/data/mri/wmaze/norm_stats/learning/PMA/fixed'
...
datasource_norm.inputs.field_template = dict(copes = 'scndlvl/learning/PMA/fixed/%s/fixedfx/cope*.nii.gz',
                                             varcopes = 'scndlvl/learning/PMA/fixed/%s/fixedfx/varcope*.nii.gz',
