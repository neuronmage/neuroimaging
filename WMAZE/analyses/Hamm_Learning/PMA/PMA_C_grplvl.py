...
- python PMA_cond_grplvl.py -s WMAZE_001
                         -o /home/data/madlab/data/mri/wmaze/grp_lvl/learning/PMA/cond
                         -w /scratch/madlab/crash/mandy/learning/PMA/cond/grp_lvl
...
work_dir = '/scratch/madlab/wmaze/grplvl/learning/PMA/cond/grp_lvl'
...
datasource.inputs.field_template = dict(copes = 'norm_stats/learning/PMA/cond/%s/norm_copes/cope_%s_trans.nii.gz',
                                        varcopes = 'norm_stats/learning/PMA/cond/%s/norm_varcopes/varcope_%s_trans.nii.gz')
...
group_randomise_sinker.inputs.base_directory = '/home/data/madlab/data/mri/wmaze/grplvl/learning/PMA/cond'
