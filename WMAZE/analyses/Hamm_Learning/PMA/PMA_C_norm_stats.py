...
- WMAZE Learning analysis Version PMA 
...
- python norm_stats.py -s WMAZE_001
  			 -o /home/data/madlab/data/mri/wmaze/norm_stats/learning/PMA/cond
                         -w /scratch/madlab/crash/mandy/learning/PMA/cond/norm_stats 
"""
...
work_dir = '/scratch/madlab/crash/mandy/learning/PMA/cond/norm_stats'
sink_dir = '/home/data/madlab/data/mri/wmaze/norm_stats/learning/PMA/cond'
...
datasource_norm.inputs.field_template = dict(copes = 'scndlvl/learning/PMA/cond/%s/fixedfx/cope*.nii.gz',
                                             varcopes = 'scndlvl/learning/PMA/cond/%s/fixedfx/varcope*.nii.gz',
