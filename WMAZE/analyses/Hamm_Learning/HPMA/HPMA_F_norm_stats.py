...
- python norm_stats.py -s WMAZE_001
                         -o /home/data/madlab/data/mri/wmaze/norm_stats/learning/HPMA
                         -w /scratch/madlab/crash/mandy_learning/HPMA/norm_stats 
"""
...
work_dir = '/scratch/madlab/crash/mandy/learning/HPMA/norm_stats'
sink_dir = '/home/data/madlab/data/mri/wmaze/norm_stats/learning/HPMA'
...
datasource_norm.inputs.field_template = dict(copes = 'scndlvl/learning/HPMA/%s/fixedfx/cope*.nii.gz',
                                             varcopes = 'scndlvl/learning/HPMA/%s/fixedfx/varcope*.nii.gz',
