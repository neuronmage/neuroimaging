...
"""
=====================================================
Learning Analysis -- Conditional Trials -- Model HPMA
=====================================================
...
- WMAZE Model HPMA
  ...
  - EV directory (Model HPMA) --- /home/data/madlab/Mattfeld_WMAZE/sourcedata/behav/WMAZE_001/model_HPMA
- python HPMA_C_grplvl.py -s WMAZE_001
                       	  -o /home/data/madlab/Mattfeld_WMAZE/dset/analyses/model_HPMA/grp_lvl/cond
                      	  -w /scratch/data/crash/mandy/learning/HPMA/cond/grp_lvl
...
work_dir = '/home/data/madlab/mandy/learning/HPMA/grp_lvl/cond'
group_wf = Workflow('group_wf')
group_wf.base_dir = work_dir


contrasts = ['AllVsBase', 'all_remaining', 'early_learn_event', 'late_learn_event', 'early_nonlearn_event', 'late_nonlearn_event',
             'early_learn_pmod', 'late_learn_pmod', 'early_nonlearn_pmod', 'late_nonlearn_pmod',
             'event_early_learn_minus_pmod_early_learn', 'pmod_early_learn_minus_event_early_learn', 
             'event_late_learn_minus_pmod_late_learn', 'pmod_late_learn_minus_event_late_learn', 
             'event_early_nonlearn_minus_pmod_early_nonlearn', 'pmod_early_nonlearn_minus_event_early_nonlearn', 
             'event_late_nonlearn_minus_pmod_late_nonlearn', 'pmod_late_nonlearn_minus_event_late_nonlearn']

#removed 007 (no late_nonlearning in any set)
sids = ['WMAZE_001', 'WMAZE_002', 'WMAZE_004', 'WMAZE_005', 'WMAZE_006', 'WMAZE_008', 'WMAZE_009', 'WMAZE_010', 'WMAZE_012', 
...
datasource.inputs.field_template = dict(copes='dset/analyses/learning/HALVES/norm_stats/cond/%s/norm_copes/cope_%s_trans.nii.gz',
                                        varcopes='dset/analyses/learning/HALVES/norm_stats/cond/%s/norm_varcopes/varcope_%s_trans.nii.gz')
...
#Identity interface to hold and store information for input into future nodes
...
#concatenate the varcopes into single image across time
...
#create group-specific level 2 model 
...
#concatenate the copes into single image across time
...
#group_randomise.sinker
group_randomise_sinker = Node(DataSink(infields = None), name = 'group_randomise_sinker')
group_randomise_sinker.inputs.base_directory = '/home/data/madlab/Mattfeld_WMAZE/dset/analyses/learning/HPMA/grp_lvl/cond/'
