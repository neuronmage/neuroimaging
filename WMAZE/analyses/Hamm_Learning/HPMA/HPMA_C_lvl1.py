...
- python HPMA_C_lvl1.py -s WMAZE_001
                       	-o /home/data/madlab/data/mri/wmaze/frstlvl/learning/HPMA_C
                        -w /scratch/madlab/crash/mandy/learning/HPMA/lvl1
...
def subjectinfo(subject_id):
    ...
    data_early_learn_event = np.genfromtxt(base_proj_dir + '/{0}/model_HPMA_C/set{1}_early_learn_event.txt'.format(subject_id,curr_set),dtype = str)
    data_late_learn_event = np.genfromtxt(base_proj_dir + '/{0}/model_HPMA_C/set{1}_late_learn_event.txt'.format(subject_id,curr_set),dtype = str)
    data_early_nonlearn_event = np.genfromtxt(base_proj_dir + '/{0}/model_HPMA_C/set{1}_early_nonlearn_event.txt'.format(subject_id,curr_set),dtype = str)
    data_late_nonlearn_event = np.genfromtxt(base_proj_dir + '/{0}/model_HPMA_C/set{1}_late_nonlearn_event.txt'.format(subject_id,curr_set),dtype = str)
    data_early_learn_pmod = np.genfromtxt(base_proj_dir + '/{0}/model_HPMA_C/set{1}_early_learn_pmod.txt'.format(subject_id,curr_set),dtype = str)
    data_late_learn_pmod = np.genfromtxt(base_proj_dir + '/{0}/model_HPMA_C/set{1}_late_learn_pmod.txt'.format(subject_id,curr_set),dtype = str)
    data_early_nonlearn_pmod = np.genfromtxt(base_proj_dir + '/{0}/model_HPMA_C/set{1}_early_nonlearn_pmod.txt'.format(subject_id,curr_set),dtype = str)
    data_late_nonlearn_pmod = np.genfromtxt(base_proj_dir + '/{0}/model_HPMA_C/set{1}_late_nonlearn_pmod.txt'.format(subject_id,curr_set),dtype = str)
    data_all_remaining = np.genfromtxt(base_proj_dir + '/{0}/model_HPMA_C/set{1}_all_remaining.txt'.format(subject_id,curr_set),dtype = str)  
...
if __name__ == "__main__":
    ...
    wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/mandy/learning/HPMA_C/lvl1/3'
