...
- python BINS_cond_grplvl.py -s WMAZE_001
                       	     -o /home/data/madlab/Mattfeld_WMAZE/dset/analyses/model_BINS/grp_lvl/cond
                      	     -w /scratch/data/crash/mandy/learning/BINS/cond/grp_lvl
"""
...
contrasts = ['cond_bin1', 'cond_bin2', 'cond_bin3',  
...
work_dir = '/home/data/madlab/mandy/learning/BINS/grp_lvl/cond'
...
datasource.inputs.field_template = dict(copes = 'dset/analyses/learning/BINS/norm_stats/cond/%s/norm_copes/cope_%s_trans.nii.gz',
                                        varcopes = 'dset/analyses/learning/BINS/norm_stats/cond/%s/norm_varcopes/varcope_%s_trans.nii.gz')
...
group_randomise_sinker.inputs.base_directory = '/home/data/madlab/Mattfeld_WMAZE/dset/analyses/learning/BINS/grp_lvl/cond/'
