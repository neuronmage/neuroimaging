...
"""
=========================================
Learning Analysis -- BINS -- Fixed Trials
=========================================
First level workflow for UM GE 750 wmaze task data

- WMAZE Learning analysis Version BIN (Binned based on learning fixed)
...
- python BINS_fixed_lvl1.py -s WMAZE_001
                       -o /home/data/madlab/data/mri/wmaze/frstlvl/learning/BINS/fixed
                       -w /scratch/madlab/crash/mandy/learning/BINS/fixed/lvl1
...
def subjectinfo(subject_id):
    ...
    data_fixed_bin1 = np.genfromtxt(base_proj_dir + '/{0}/model_BINS/set{1}_fixed_bin1.txt'.format(subject_id, curr_set), dtype = str)
    data_fixed_bin2 = np.genfromtxt(base_proj_dir + '/{0}/model_BINS/set{1}_fixed_bin2.txt'.format(subject_id, curr_set), dtype = str) 
    data_fixed_bin3 = np.genfromtxt(base_proj_dir + '/{0}/model_BINS/set{1}_fixed_bin3.txt'.format(subject_id, curr_set), dtype = str)    
    data_all_remaining = np.genfromtxt(base_proj_dir + '/{0}/model_BINS/set{1}_all_remaining_FIXED.txt'.format(subject_id, curr_set), dtype = str)  
...
def get_contrasts(subject_id, info):
    ...
    if 'fixed_bin1' in j.conditions and 'fixed_bin2' in j.conditions:
        cont_bin1_vs_bin2 = ['bin1_minus_bin2', 'T', ['fixed_bin1','fixed_bin2'], [1, -1]]
        cont_bin2_vs_bin1 = ['bin2_minus_bin1', 'T', ['fixed_bin2','fixed_bin1'], [1, -1]]
        contrasts.append(cont_bin1_vs_bin2)
        contrasts.append(cont_bin2_vs_bin1)
    if 'fixed_bin1' in j.conditions and 'fixed_bin3' in j.conditions:
        cont_bin1_vs_bin3 = ['bin1_minus_bin3', 'T', ['fixed_bin1','fixed_bin3'], [1, -1]]
        cont_bin3_vs_bin1 = ['bin3_minus_bin1', 'T', ['fixed_bin3','fixed_bin1'], [1, -1]]
        contrasts.append(cont_bin1_vs_bin3)
        contrasts.append(cont_bin3_vs_bin1)
    if 'fixed_bin2' in j.conditions and 'fixed_bin3' in j.conditions:
        cont_bin2_vs_bin3 = ['bin2_minus_bin3', 'T', ['fixed_bin2','fixed_bin3'], [1, -1]]
        cont_bin3_vs_bin2 = ['bin3_minus_bin2', 'T', ['fixed_bin3','fixed_bin2'], [1, -1]]
...
if __name__ == "__main__":
    ...
    wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/mandy/learning/BINS/fixed/lvl1/3'
