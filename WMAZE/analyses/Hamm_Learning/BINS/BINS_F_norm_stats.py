...
- python RSA1_fixed_norm_stats.py -s WMAZE_001
                       	   -o /home/data/madlab/Mattfeld_WMAZE/dset/analyses/model_BINS/norm_stats/fixed
                      	   -w /scratch/data/crash/mandy/learning/BINS/fixed/norm_stats
"""
...
work_dir = '/home/data/madlab/mandy/learning/BINS/norm_stats/fixed'
sink_dir = '/home/data/madlab/Mattfeld_WMAZE/dset/analyses/learning/BINS/norm_stats/fixed'
...
subj_iterable = Node(IdentityInterface(fields = ['subject_id'], mandatory_inputs = True), name = 'subj_interable')
...
datasource_norm.inputs.field_template = dict(copes = 'dset/analyses/learning/BINS/lvl2/fixed/%s/fixedfx/cope*.nii.gz',
                                             varcopes = 'dset/analyses/learning/BINS/lvl2/fixed/%s/fixedfx/varcope*.nii.gz',
...
getcontrasts = Node(Function(input_names = ['data_inputs'], output_names = ['contrasts'], function = get_contrasts), name = 'getcontrasts')
...
getsubs = Node(Function(input_names = ['subject_id', 'cons'], output_names = ['subs'], function = get_substitutions), name = 'getsubs')
