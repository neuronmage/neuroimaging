...
- python RSA1_cond_lvl1.py -s WMAZE_001
                       	   -o /home/data/madlab/Mattfeld_WMAZE/dset/analyses/model_BINS/lvl1/cond
                      	   -w /scratch/data/crash/mandy/learning/BINS/cond/lvl1
...
def subjectinfo(subject_id):
    ...
    data_cond_bin1 = np.genfromtxt(base_proj_dir + '/{0}/model_BINS/set{1}_cond_bin1.txt'.format(subject_id,curr_set),dtype=str)
    data_cond_bin2 = np.genfromtxt(base_proj_dir + '/{0}/model_BINS/set{1}_cond_bin2.txt'.format(subject_id,curr_set),dtype=str) 
    data_cond_bin3 = np.genfromtxt(base_proj_dir + '/{0}/model_BINS/set{1}_cond_bin3.txt'.format(subject_id,curr_set),dtype=str)    
    data_all_remaining = np.genfromtxt(base_proj_dir + 
				       '/{0}/model_BINS/set{1}_all_remaining_COND.txt'.format(subject_id,curr_set),dtype=str)  
...
def get_contrasts(subject_id, info):
    ...
    if 'cond_bin1' in j.conditions and 'cond_bin3' in j.conditions:
        cont_bin1_vs_bin3 = ['bin1_minus_bin3', 'T', ['cond_bin1','cond_bin3'], [1, -1]]
        cont_bin3_vs_bin1 = ['bin3_minus_bin1', 'T', ['cond_bin3','cond_bin1'], [1, -1]]
        contrasts.append(cont_bin1_vs_bin3)
        contrasts.append(cont_bin3_vs_bin1)
    if 'cond_bin2' in j.conditions and 'cond_bin3' in j.conditions:
        cont_bin2_vs_bin3 = ['bin2_minus_bin3', 'T', ['cond_bin2','cond_bin3'], [1, -1]]
        cont_bin3_vs_bin2 = ['bin3_minus_bin2', 'T', ['cond_bin3','cond_bin2'], [1, -1]]
...
if __name__ == "__main__":
    ...
    wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/mandy/learning/BINS/cond/lvl1/1'
