...
- python HALVES_F_norm_stats.py -s WMAZE_001
                       	        -o /home/data/madlab/Mattfeld_WMAZE/dset/analyses/model_HALVES/norm_stats/fixed
                      	        -w /scratch/data/crash/mandy/learning/HALVES/fixed/norm_stats
...
work_dir = '/home/data/madlab/mandy/learning/HALVES/norm_stats/fixed'
sink_dir = '/home/data/madlab/Mattfeld_WMAZE/dset/analyses/learning/HALVES/norm_stats/fixed'
...
datasource_norm.inputs.field_template = dict(copes = 'dset/analyses/learning/HALVES/lvl2/fixed/%s/fixedfx/cope*.nii.gz',
                                             varcopes = 'dset/analyses/learning/HALVES/lvl2/fixed/%s/fixedfx/varcope*.nii.gz',
