...
"""
===================================================
Learning Analysis -- HALVES_C -- Conditional Trials
===================================================
...
- WMAZE Learning Analysis Version HALVES (Derivative & Early vs. Late)
  ...
  - EV directory (model_HALVES_C) --- /home/data/madlab/Mattfeld_WMAZE/sourcedata/behav/WMAZE_001/model_HALVES_C
- python HALVES_cond_lvl1.py -s WMAZE_001
                       	     -o /home/data/madlab/Mattfeld_WMAZE/dset/analyses/model_HALVES/lvl1/cond
                      	     -w /scratch/data/crash/mandy/learning/HALVES/cond/lvl1
...
def subjectinfo(subject_id):
    ...
    data_early_learning = np.genfromtxt(base_proj_dir+'/{0}/model_HALVES_C/set{1}_early_learn.txt'.format(subject_id,curr_set),dtype=str)

    data_late_learning = np.genfromtxt(base_proj_dir+'/{0}/model_HALVES_C/set{1}_late_learn.txt'.format(subject_id,curr_set),dtype=str)

    data_early_nonlearning=np.genfromtxt(base_proj_dir+'/{0}/model_HALVES_C/set{1}_early_nonlearn.txt'.format(subject_id,curr_set),dtype=str)

    data_late_nonlearning = np.genfromtxt(base_proj_dir+'/{0}/model_HALVES_C/set{1}_late_nonlearn.txt'.format(subject_id,curr_set),dtype=str)
 
    data_all_remaining = np.genfromtxt(base_proj_dir+'/{0}/model_HALVES_C/set{1}_all_remaining.txt'.format(subject_id,curr_set),dtype=str)  
...
if __name__ == "__main__":
    ...
    wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/mandy/learning/HALVES/cond/lvl1/1'
