...
"""
==============================================================
Learning Analysis -- HALVES -- Fixed Before Conditional Trials
==============================================================
...
- python HALVES_F_lvl2.py -s WMAZE_001
                       	  -o /home/data/madlab/Mattfeld_WMAZE/dset/analyses/model_HALVES/lvl2/fixed
                      	  -w /scratch/data/crash/mandy/learning/HALVES/fixed/lvl2
"""
...
def secondlevel_wf(subject_id,
    ...
    for curr_cont in all_contrasts:
        cont_files = glob(os.path.join(base_dir, 
                          'learning/HALVES/lvl1/fixed/{0}/modelfit/contrasts/_estimate_model*/cope??_{1}.nii.gz'.format(subject_id,curr_cont)))
        if len(cont_files) > 1:
    ...
    datasource.inputs.field_template = dict(copes = 'dset/analyses/learning/HALVES/lvl1/fixed/%s/modelfit/contrasts/_estimate_model*/cope*_%s.nii.gz',
                                            varcopes = 'dset/analyses/learning/HALVES/lvl1/fixed/%s/modelfit/contrasts/_estimate_model*/varcope*_%s.nii.gz',
                                            mask_file = 'sourcedata/mri/preproc/%s/ref/_fs_threshold20/%s*_thresh.nii',
                                            dof_files = 'dset/analyses/learning/HALVES/lvl1/fixed/%s/modelfit/dofs/_estimate_model%s/%s')     
...
if __name__ == "__main__":
    ...
    wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/mandy/learning/HALVES/fixed/lvl2'
