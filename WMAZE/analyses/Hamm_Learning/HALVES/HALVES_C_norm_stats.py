...
- WMAZE Model Halves Conditional
...
- python HALVES_C_norm_stats.py -s WMAZE_001
                       	        -o /home/data/madlab/Mattfeld_WMAZE/dset/analyses/model_HALVES/norm_stats/cond
                      	        -w /scratch/data/crash/mandy/learning/HALVES/cond/norm_stats
"""
...
work_dir = '/home/data/madlab/mandy/learning/HALVES/norm_stats/cond'
sink_dir = '/home/data/madlab/Mattfeld_WMAZE/dset/analyses/learning/HALVES/norm_stats/cond'
...
#datasource node to iterate through sids and import files
...
datasource_norm.inputs.field_template = dict(copes = 'dset/analyses/learning/HALVES/lvl2/cond/%s/fixedfx/cope*.nii.gz',
                                             varcopes = 'dset/analyses/learning/HALVES/lvl2/cond/%s/fixedfx/varcope*.nii.gz',
...
#node to convert FreeSurfer-style Affine registration into ANTS compatible itk format
...
varcope2targ = MapNode(ants.ApplyTransforms(), iterfield = ['input_image'], 
                       name = 'varcope2targ')
varcope2targ.inputs.input_image_type = 3 #defines input type as "timeseries"
...
#function node to rename output files
