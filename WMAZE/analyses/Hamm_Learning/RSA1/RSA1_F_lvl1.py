...
"""
=========================================================
WMAZE_fMRI: Fixed before Conditional Trials -- Model RSA1
=========================================================
...
- python RSA1_cond_lvl1.py -s WMAZE_001
                       	   -o /home/data/madlab/Mattfeld_WMAZE/dset/analyses/model_RSA1/lvl1/fixed
...
def subjectinfo(subject_id):
    ...
    for curr_run in range(1,7):
        ...
        data_B_corr = np.genfromtxt(base_proj_dir + '/{0}/model_RSA1/run{1}_all_before_B_corr.txt'.format(subject_id,curr_run),dtype = str) 
        data_B_incorr = np.genfromtxt(base_proj_dir + '/{0}/model_RSA1/run{1}_all_before_B_incorr.txt'.format(subject_id,curr_run),dtype = str)
        data_all_remaining = np.genfromtxt(base_proj_dir + 
                                           '/{0}/model_RSA1/run{1}_all_remaining.txt'.format(subject_id,curr_run),dtype = str)      
...
if __name__ == "__main__":
    ...
    wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/mandy/learning/RSA1/fixed/lvl1/'
