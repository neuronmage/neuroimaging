...
=============================================
Normal statistics workflow for Seimens vCAT task data

- vCAT GLM2 
  - Use FSL ROI to recreate EPI data
  - EV directory (GLM2) --- /home/data/madlab/Mattfeld_vCAT/behav/sub-0??/GLM2

- python GLM2_norm_stats.py -s sub-0??
                            -o /home/data/madlab/Mattfeld_vCAT/derivatives/GLM2/norm_stats/sub-0??
                            -w /scratch/madlab/crash/mandy/vcat/GLM2/norm_stats/sub-0??
"""
...
work_dir = '/scratch/madlab/crash/mandy/vcat/GLM2/norm_stats'
sink_dir = '/home/data/madlab/Mattfeld_vCAT/derivatives/GLM2/norm_stats'
...
datasource.inputs.field_template = dict(copes = 'GLM2/lvl2/%s/fixedfx/cope*.nii.gz', #copes and varcopes from 2nd level pipeline
                                        varcopes = 'GLM2/lvl2/%s/fixedfx/varcope*.nii.gz',                                            
...
norm_stats_wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/mandy/vcat/GLM2/norm_stats/'
